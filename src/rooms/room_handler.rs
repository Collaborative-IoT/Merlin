use crate::communication::communication_types::{
    BasicResponse, RoomPermissions, VoiceServerClosePeer,
    VoiceServerJoinAsSpeaker,VoiceServerCreateRoom
};
use lapin::Channel;
use crate::communication::data_capturer::CaptureResult;
use crate::communication::{data_capturer, data_fetcher};
use crate::data_store::db_models::{DBRoomBlock,DBRoom};
...
async fn continue_with_successful_room_creation(room_id:i32, channel: &Channel, public:bool,server_state: &mut ServerState,){
