...
use crate::communication::tests::{hand_tests, mod_tests, owner_tests, standard_tests};
use crate::communication::types::{GenericRoomId, GenericRoomIdAndPeerId};
...
pub async fn tests() {
    ...
    standard_tests::test_creating_room(
        &mut consumer,
        &publish_channel,
        &mock_state,
        &execution_handler,
    ...
    .await;
    //speaker
    standard_tests::test_joining_room(
        &mut consumer,
        &publish_channel,
        &mock_state,
        &execution_handler,
    ...
    hand_tests::users_in_room_as_listener_can_raise(
        &mut rx_user_two,
        &publish_channel,
        &execution_handler,
        &mock_state,
    ...
    standard_tests::test_users_can_get_top_rooms(
        &execution_handler,
        &mock_state,
        &mut rx_user_one,
        &publish_channel,
    ...
    .await;
    standard_tests::test_getting_all_users_in_room(
        &execution_handler,
        &mock_state,
        &publish_channel,
        &mut consumer,
    ...
    .await;
    standard_tests::test_invalid_webrtc_request(
        &execution_handler,
        &mock_state,
        &publish_channel,
        &mut rx_user_one,
    ...
    .await;
    standard_tests::test_unfollowing_and_following_user(
        &mut consumer,
        &publish_channel,
        &mock_state,
        &execution_handler,
    ...
    .await;
    standard_tests::test_blocking_and_unblocking_user(
        &mut consumer,
        &publish_channel,
        &mock_state,
        &execution_handler,
    ...
    .await;
    standard_tests::test_blocking_and_unblocking_user_invalid(
        &mut consumer,
        &publish_channel,
        &mock_state,
        &execution_handler,
    ...
    standard_tests::test_updating_room_meta_data(
        &mut consumer,
        &publish_channel,
        &mock_state,
        &execution_handler,
    ...
    standard_tests::test_updating_muted_and_deaf(
        &publish_channel,
        &mock_state,
        &execution_handler,
        &mut rx_user_one,
    ...
    standard_tests::test_leaving_room_without_cleanup(
        &mut consumer,
        &publish_channel,
        &mock_state,
        &execution_handler,
    ...
    .await;
    standard_tests::test_leaving_room_with_cleanup(
        &mut consumer,
        &publish_channel,
        &mock_state,
        &execution_handler,
...
async fn test_raising_and_lowering_hand(
    ...
    hand_tests::users_not_in_room_cannot_make_requests(publish_channel, execution_handler, state)
        .await;
    hand_tests::users_in_room_as_listener_can_raise(
        listener_rx,
        publish_channel,
    ...
    .await;
    mod_tests::non_mods_can_not_lower_hands(
        publish_channel,
        execution_handler,
        state,
        consume_channel,
    ...
    .await;
    mod_tests::mods_can_lower_hands(
        listener_rx,
        publish_channel,
        execution_handler,
        state,
    ...
    .await;
    hand_tests::users_can_lower_their_own_hand(
        listener_rx,
        publish_channel,
        execution_handler,
        state,
...
async fn test_adding_speaker(
    ...
    mod_tests::non_mods_can_not_bring_up_speakers(
        publish_channel,
        execution_handler,
        state,
        consume_channel,
    ...
    .await;
    mod_tests::mods_can_bring_up_speakers(
        consume_channel,
        publish_channel,
        execution_handler,
        state,
...
async fn test_removing_speaker(
    ...
    mod_tests::non_mods_can_not_remove_speaker(
        publish_channel,
        execution_handler,
        state,
        consume_channel,
    ...
    .await;
    mod_tests::mods_can_remove_speaker(consume_channel, publish_channel, execution_handler, state)
        .await;
}
...
async fn test_blocking_from_room(
    ...
    owner_tests::non_owner_can_not_block_from_room(
        publish_channel,
        execution_handler,
        state,
        listener_rx,
    ...
    .await;
    owner_tests::owner_can_block_from_room(
        consume_channel,
        publish_channel,
        execution_handler,
        state,
